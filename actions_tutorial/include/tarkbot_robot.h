...
//ROS相关头文件
#include <ros/ros.h>   
#include <tarkbot_robot/JointCmd.h>
#include <tarkbot_robot/JointState.h> 
...
#define  ID_ROS2CRP_ARM     0x60    //ROS向下位机发送的机械臂数据
...
class TarkbotRobot
{
    ...
    private:
        ...
        //机械臂回调函数
        void joint_cmd_callback(const tarkbot_robot::JointCmd::ConstPtr &msg);
        //动态参数配置回调函数
        ...
        void SetPreDefinedPos();//设置机械臂初始位置
        ...
        int jointstate_list_[6]={0, -385, -860, -570, 0, 0}; //机械臂数据
        ...
        tarkbot_robot::JointState joint_state_pub_data_; //机械臂状态消息发布
